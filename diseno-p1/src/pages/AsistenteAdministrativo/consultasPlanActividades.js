        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell style={{ backgroundColor:'#EEE1B0'}}>Tipo</TableCell>
              <TableCell style={{ backgroundColor:'#EEE1B0'}}>Fecha</TableCell>
              <TableCell style={{ backgroundColor:'#EEE1B0'}}>Responsables</TableCell>
              <TableCell style={{ backgroundColor:'#EEE1B0'}}>Modalidad</TableCell>
              <TableCell style={{ backgroundColor:'#EEE1B0'}}>Estado</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            <TableRow>
